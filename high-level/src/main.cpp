...
void loop() {
    ...
    state_manager.getWrist()->getPitch()->setMotorValue(state_manager.getKinematics()->toShaft((state_manager.getKinematics()->RevToDeg(encoder.Pos_Estimate))));
    Serial.print("Motor ");
    Serial.print(0);
    Serial.print(" is at ");
    ...
    // motor ang is motor shaft ang
    state_manager.getWrist()->getYaw()->setMotorValue(state_manager.getKinematics()->toShaft((state_manager.getKinematics()->RevToDeg(encoder.Pos_Estimate))));
    Serial.print("Motor ");
    Serial.print(1);
    Serial.print(" is at ");
