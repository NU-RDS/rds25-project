...
class SerialGUI:
    ...
    def livePlot(self, duration=3.0):  # Default to 3 seconds
        ...
        print(f"Collecting data for {duration} seconds... (Press Enter to stop earlier)")
                ...
                if self.ser.in_waiting > 0:
                    ...
                    if timestamp is not None:
                        ...
                        if sample_count % 100 == 0:
                            ...
                            print(f"Time: {timestamp:.1f}ms, Ref: {ref:.3f}, Act: {data:.3f}")
...
if __name__ == "__main__":
    ...
    default_port = '/dev/tty.usbmodem166396801'  # Change this to your Teensy port     
